...
FROM (
    ...
    GROUP BY d.F4602
                    ...
                    ON maxs.F4602 = allTimes.F4602
                        AND maxs.maxEnterTime = allTimes.EnterTime
         LEFT JOIN (
...
WHERE (
  ...
  AND (allTimes.STATUS = 2 OR allTimes.STATUS = 1)