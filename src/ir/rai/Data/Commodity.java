...
import ir.rai.Data.oldOnes.Wagon;
...
public class Commodity {
    ...
    public Commodity(int id, double priority, String origin, String mainDestination,
        ...
        boolean flag = true;
        for (String name : ReadTypicalData.jonoobStations) {
            if (mainDestination.equals(name)) {
                this.destination = ReadTypicalData.Stations.get(ReadTypicalData.Stations.size() - 1).getName();
                flag = false;
            }
        }

        for (Station station : ReadTypicalData.Stations) {
        ...
        if (flag) {
            this.destination = ReadTypicalData.Stations.get(0).getName();
        }
    }
    ...
    public void setOriginId() {
        for (ManovrStation manovrStation : ReadTypicalData.manovrStations) {
